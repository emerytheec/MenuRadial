...
{
    /// <summary>
    /// Clase base para entradas de componentes VRChat (PhysBone y Collider).
    /// Almacena la información necesaria para reubicar y revertir un componente.
    /// </summary>
    [Serializable]
    public abstract class ComponentEntry
    {
        ...
        /// <summary>
        /// El Transform raíz del componente (rootTransform del componente).
        ...
        /// <summary>
        /// Nombre generado para el nuevo GameObject.
        /// </summary>
        ...
        /// <summary>
        /// Si debe incluirse durante la reubicación.
        /// </summary>
        ...
        protected ComponentEntry(Component component, Transform originalTransform, Transform rootTransform, OrganizationContext context)
        {
        ...
        /// <summary>
        /// Genera el nombre por defecto para esta entrada. Implementar en subclases con el prefijo adecuado.
        /// </summary>
